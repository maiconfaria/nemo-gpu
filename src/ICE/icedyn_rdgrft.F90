...
INTEGER ::  pos
      ...
      !!-------------------------------------------------------------------
      !
      pos=index(numnam_ice_ref,"&namdyn_rdgrft") 
      READ  ( numnam_ice_ref(pos:), namdyn_rdgrft, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namdyn_rdgrft in reference namelist' )
      pos=index(numnam_ice_cfg,"&namdyn_rdgrft") 
      READ  ( numnam_ice_cfg(pos:), namdyn_rdgrft, IOSTAT = ios, ERR = 902 )
