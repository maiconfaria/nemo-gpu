...
INTEGER ::  pos
      ...
      !!----------------------------------------------------------------------
      !
      pos=index(numnam_ref,"&namzdf_iwm") 
      READ  ( numnam_ref(pos:), namzdf_iwm, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namzdf_iwm in reference namelist' )
      !
      pos=index(numnam_cfg,"&namzdf_iwm") 
      READ  ( numnam_cfg(pos:), namzdf_iwm, IOSTAT = ios, ERR = 902 )
