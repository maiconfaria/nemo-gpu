...
INTEGER ::  pos
      ...
      pos=index(numnam_ref,"&nam_asminc") 
      READ  ( numnam_ref(pos:), nam_asminc, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'nam_asminc in reference namelist' )
      pos=index(numnam_cfg,"&nam_asminc") 
      READ  ( numnam_cfg(pos:), nam_asminc, IOSTAT = ios, ERR = 902 )
