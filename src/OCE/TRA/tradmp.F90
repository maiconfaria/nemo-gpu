...
INTEGER ::  pos
      ...
      !!----------------------------------------------------------------------
      !
      pos=index(numnam_ref,"&namtra_dmp") 
      READ  ( numnam_ref(pos:), namtra_dmp, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namtra_dmp in reference namelist' )
      !
      pos=index(numnam_cfg,"&namtra_dmp") 
      READ  ( numnam_cfg(pos:), namtra_dmp, IOSTAT = ios, ERR = 902 )
