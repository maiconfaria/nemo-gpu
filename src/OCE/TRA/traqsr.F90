...
INTEGER ::  pos
      ...
      !!----------------------------------------------------------------------
      !
      pos=index(numnam_ref,"&namtra_qsr") 
      READ  ( numnam_ref(pos:), namtra_qsr, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namtra_qsr in reference namelist' )
      !
      pos=index(numnam_cfg,"&namtra_qsr") 
      READ  ( numnam_cfg(pos:), namtra_qsr, IOSTAT = ios, ERR = 902 )
