...
INTEGER ::  pos
      ...
      ! ================================ !
      !
      pos=index(numnam_ref,"&namsbc_cpl") 
      READ  ( numnam_ref(pos:), namsbc_cpl, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namsbc_cpl in reference namelist' )
      !
      pos=index(numnam_cfg,"&namsbc_cpl") 
      READ  ( numnam_cfg(pos:), namsbc_cpl, IOSTAT = ios, ERR = 902 )
