...
CONTAINS
    SUBROUTINE setdevice()
        nodesize  = 40                                                    !Node number of MPI processes, CTE-Power default 40
        cusocket  = 2                                                    !Number of NVlink or PCI-E nodes, CTE-Power default 2
        cudadev   = 4                                                    !Number of GPUs on a node, CTE-Power default 4
