...
INTEGER ::  pos
      ...
      !!----------------------------------------------------------------------
      !
      pos=index(numnam_ref,"&namdyn_hpg") 
      READ  ( numnam_ref(pos:), namdyn_hpg, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namdyn_hpg in reference namelist' )
      !
      pos=index(numnam_cfg,"&namdyn_hpg") 
      READ  ( numnam_cfg(pos:), namdyn_hpg, IOSTAT = ios, ERR = 902 )
