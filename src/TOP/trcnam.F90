...
INTEGER ::  pos
      ...
      !
      pos=index(numnat_ref,"&namtrc_run") 
      READ  ( numnat_ref(pos:), namtrc_run, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namtrc in reference namelist' )
      pos=index(numnat_cfg,"&namtrc_run") 
      READ  ( numnat_cfg(pos:), namtrc_run, IOSTAT = ios, ERR = 902 )
...
INTEGER ::  pos
      ...
      pos=index(numnat_ref,"&namtrc ") 
      READ  ( numnat_ref(pos:), namtrc, IOSTAT = ios, ERR = 901)
901   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namtrc in reference namelist' )
      pos=index(numnat_cfg,"&namtrc ") 
      READ  ( numnat_cfg(pos:), namtrc, IOSTAT = ios, ERR = 902 )
902   IF( ios >  0 )   CALL ctl_nam ( ios , 'namtrc in configuration namelist' )
...
INTEGER ::  pos
      ...
      !
      pos=index(numnat_ref,"&namtrc_trd") 
      READ  ( numnat_ref(pos:), namtrc_trd, IOSTAT = ios, ERR = 905)
905   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namtrc_trd in reference namelist' )
      pos=index(numnat_cfg,"&namtrc_trd") 
      READ  ( numnat_cfg(pos:), namtrc_trd, IOSTAT = ios, ERR = 906 )
