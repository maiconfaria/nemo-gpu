...
INTEGER ::  pos
      ...
      !!--------------------------------------------------------------------------------------
      !
      pos=index(numnam_ref,"&namagrif") 
      READ  ( numnam_ref(pos:), namagrif, IOSTAT = ios, ERR = 901)
901 IF( ios /= 0 )   CALL ctl_nam ( ios , 'namagrif in reference namelist' )
      pos=index(numnam_cfg,"&namagrif") 
      READ  ( numnam_cfg(pos:), namagrif, IOSTAT = ios, ERR = 902 )
