...
INTEGER ::  pos
      ...
      pos=index(numnam_ref,"&namsbc_abl") 
      READ  ( numnam_ref(pos:), namsbc_abl, IOSTAT = ios, ERR = 901 )
901   IF( ios /= 0 ) CALL ctl_nam ( ios , 'namsbc_abl in reference namelist' )
      ...
      pos=index(numnam_cfg,"&namsbc_abl") 
      READ  ( numnam_cfg(pos:), namsbc_abl, IOSTAT = ios, ERR = 902 )
